...
unsigned int ns[] = { 10, 100, 1000, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 250000, 500000, 1000000 };
...
void (*sort_functions[])(int *, unsigned int) = { selectionSort, heapSort, insertion_sort, quick_sort };
